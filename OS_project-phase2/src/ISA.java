...
//        Reset_flag(); // resetting the flag
    ...
    public void PUSH(String R1){
        int index = (int)Integer.parseInt(R1);
        System.out.println(index);
        int[] arr1 = Memory.tranlation(index);
...
//        Memory.memory1[arr1[0]].page[arr1[1]] = s1;
    ...
    public short POP(){
        ...
        short c = (short)(Byte.toUnsignedInt(a )+ Byte.toUnsignedInt(b));        return(Memory.memory1[arr[0]].page[arr[1]]);
    }
